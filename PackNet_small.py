...
from utils.PackNet_manager_small import Manager
from dataloader import RandSplitCIFAR100, RandSplitImageNet, PermutedMNIST, RotatedMNIST
...
parser.add_argument('--taskIDs', nargs="+", type=int, default=[],
